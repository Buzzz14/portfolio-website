        ...
        >
          <div className="space-y-4 text-center lg:text-left">
            ...
            <motion.div
              ...
              className="text-2xl sm:text-2xl md:text-3xl text-slate-100 font-mono"
            >
              <span>{text}</span>
              <span>
                <Cursor />
          ...
          <motion.div
            ...
            className="flex flex-col sm:flex-row sm:space-x-2 space-y-2 sm:space-y-0 mx-auto lg:mx-0 justify-center lg:justify-start max-w-md"
          >
            <Button
              component={Link}
              to="/projects"
          ...
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 1 }}
            className="flex gap-4 items-center mx-auto lg:mx-0 justify-center lg:justify-start"
          >
            <a
